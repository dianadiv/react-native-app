    ...
    <Wrapper>
      ...
      {!loading && !error && selectedUser && 'name' in selectedUser && (
        <View>
          <TextBlock>
            <TexStyled>
              <Icon name="user" size={20} color="#fff" /> {selectedUser.name}
            </TexStyled>
            <TexStyled>
              <Icon name="envelope" size={20} color="#fff" /> {selectedUser.email}
            </TexStyled>
            <TexStyled>
              <Icon name="phone" size={20} color="#fff" /> {selectedUser.phone}
            </TexStyled>
            <TexStyled>
              <Icon name="globe" size={20} color="#fff" /> {selectedUser.website}
            </TexStyled>
            <TexStyled>
              <Icon name="compass" size={20} color="#fff" /> {selectedUser.company.name}
            </TexStyled>
          </TextBlock>
